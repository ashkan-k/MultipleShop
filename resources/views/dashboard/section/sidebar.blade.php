<div class="app-sidebar-menu overflow-hidden flex-column-fluid">
    ...
    <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5"
        ...
        <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu"
            ...
            <div data-kt-menu-trigger="click"
                 class="menu-item @if(str_starts_with(\Illuminate\Support\Facades\Route::current()->getName(), 'images')) show @endif menu-accordion">
                <span class="menu-link">
											<span class="menu-icon">
											...
											<span class="menu-title">تصاویر  و فایل ها</span>
											<span class="menu-arrow"></span>
										</span>
                <div class="menu-sub menu-sub-accordion">

                    <div class="menu-item">
                        <a class="menu-link @if(\Illuminate\Support\Facades\Route::current()->getName() == 'images') active @endif"
                           href="{{ route('images') }}">
													<span class="menu-bullet">
														<span class="bullet bullet-dot"></span>
													</span>
                            <span class="menu-title">لیست تصاویر</span>
                        </a>
                    </div>
                ...
                <div class="menu-sub menu-sub-accordion">
                    ...
                    <div class="menu-item">
                        ...
                        <a class="menu-link @if(\Illuminate\Support\Facades\Route::current()->getName() == 'dynamic_form' && str_contains(request()->url(), 'footer_social_medias')) active @endif"
                           href="{{ route('dynamic_form', ['key' => 'footer_social_medias']) }}">
													<span class="menu-bullet">
														<span class="bullet bullet-dot"></span>
													</span>
