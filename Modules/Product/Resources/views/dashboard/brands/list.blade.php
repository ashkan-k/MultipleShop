            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--begin::آیتم-->
                        <li class="breadcrumb-item text-muted">
                            <a href="{{ route('brands.index') }}" class="text-muted text-hover-primary">برند</a>
                        </li>
                        <!--end::آیتم-->
                    </ul>
                    <!--end::Breadcrumb-->
                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-toolbar">
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                <button onclick="window.location.href='{{ route('brands.create') }}'" type="button"
                                        class="btn btn-primary" data-bs-toggle="modal"
                                        data-bs-target="#kt_modal_add_user">
                                    <i class="ki-duotone ki-plus fs-2"></i>افزودن برند ها
                                </button>
                                <!--end::Add user-->
                            </div>
                            <!--end::Toolbar-->
                                    ...
                                    <td class="">
                                        ...
                                        <div
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="{{ route('brands.edit', $item->id) }}" class="menu-link px-3"
                                                   data-kt-colors-table-filter="delete_row">ویرایش</a>
                                            </div>
                                            <div class="menu-item px-3">

                                                <form action="{{ route('brands.destroy' , $item->id) }}"
...
@section('Scripts')
    ...
    <script>
        app.controller('myCtrl', function ($scope, $http) {
            @include('dashboard.section.components.bulk_actions.bulk_actions_js', ['items' => $objects, 'model' => \Modules\Product\Entities\Brand::class])
        });
    </script>
@endsection
