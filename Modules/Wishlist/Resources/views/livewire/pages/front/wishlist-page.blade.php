                                                ...
                                                <div class="profile-recent-fav-row">
                                                    <a href="#"
                                                       class="profile-recent-fav-col profile-recent-fav-col-thumb">
                                                        <img src="{{ $object->product ? $object->product->get_image() : '---' }}"
                                                    ...
                                                    <div class="profile-recent-fav-col profile-recent-fav-col-actions">
                                                        <button wire:click="RemoveFromWishlist({{ $object->id }})" class="btn-action btn-action-remove">
                                                            <i class="fa fa-trash"></i>
                                                        </button>
                                                    </div>
                                                    <div class="col-12 text-left mb-3">
                                                        <a href="{{ route('product_detail', ['slug' => $object->product ? $object->product->get_slug($lang) : '---', 'locale' => $lang]) }}" class="view-product">مشاهده محصول</a>
                                                    </div>
                                                </div>
                                            </div>
                                        @endforeach
