...
@section('title')
    @if(isset($object))
        ویرایش سبد خرید {{ $object->user->full_name() }} - {{ $object->product->title }}
    @else
        افزودن به سبد خرید
    @endif
@endsection
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--begin::آیتم-->
                        <li class="breadcrumb-item text-muted">
                            <a href="{{ route('carts.index') }}" class="text-muted text-hover-primary">سبد خرید
                                ها</a>
                        </li>
                        <!--end::آیتم-->
                    </ul>
                            ...
                            <div class="tab-pane fade show active" id="kt_ecommerce_settings_general" role="tabpanel">
                                ...
                                <form role="form" enctype="multipart/form-data"
                                    ...
                                    <div class="d-flex flex-column mb-8 fv-row">
                                        ...
                                        <input type="number" id="id_count" class="form-control form-control-solid"
                                               value="@if(old('count')){{ intval(old('count')) }}@elseif(isset($object->count)){{ $object->count }}@else{{ intval('1' )}}@endif"
                                               placeholder="تعداد را وارد کنید" name="count" required/>
