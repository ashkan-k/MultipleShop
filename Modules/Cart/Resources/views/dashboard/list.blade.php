            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--begin::آیتم-->
                        <li class="breadcrumb-item text-muted">
                            <a href="{{ route('carts.index') }}" class="text-muted text-hover-primary">سبد خرید</a>
                        </li>
                        <!--end::آیتم-->
                    </ul>
                    <!--end::Breadcrumb-->
                        ...
                        <div class="card-toolbar">
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
                                    <div class="px-7 py-5">
                                        <div class="fs-5 text-dark fw-bold">فیلتر سبد خرید ها</div>
                                    </div>
                                ...
                                <button onclick="window.location.href='{{ route('carts.create') }}'" type="button"
                                        class="btn btn-primary" data-bs-toggle="modal"
                                        data-bs-target="#kt_modal_add_user">
                                    <i class="ki-duotone ki-plus fs-2"></i>افزودن سبد خرید
                                </button>
                                <!--end::Add user-->
                            </div>
                            <!--end::Toolbar-->
                                    ...
                                    <td class="">
                                        ...
                                        <div
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="{{ route('carts.edit', $item->id) }}" class="menu-link px-3"
...
@section('Scripts')
    ...
    <script>
        app.controller('myCtrl', function ($scope, $http) {
            @include('dashboard.section.components.bulk_actions.bulk_actions_js', ['items' => $objects, 'model' => \Modules\Cart\Entities\Cart::class])
        });
    </script>
@endsection
