                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-toolbar">
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                <button onclick="window.location.href='{{ route('pages.create') }}'" type="button"
                                        class="btn btn-primary" data-bs-toggle="modal"
                                        data-bs-target="#kt_modal_add_user">
                                    <i class="ki-duotone ki-plus fs-2"></i>افزودن صفحه
                                </button>
                                <!--end::Add user-->
                            </div>
                            <!--end::Toolbar-->
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_items">
                            ...
                            @foreach ($objects as $item)
                                <tr>
                                    ...
                                    <td>
                                        <div
                                            ng-click="ChangeStatusModal({{ $item->id }}, '{{ $item->is_active ? 1 : 0 }}')"
...
@section('Scripts')
    ...
    <script>
        app.controller('myCtrl', function ($scope, $http) {
            @include('dashboard.section.components.bulk_actions.bulk_actions_js', ['items' => $objects, 'model' => \Modules\PageBuilder\Entities\PageBuilder::class])
            ...
            $scope.ChangeStatus = function () {
                ...
                $http.post(`/api/pages/status/change/${$scope.id}`, data).then(res => {
