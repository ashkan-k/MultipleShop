            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--begin::آیتم-->
                        <li class="breadcrumb-item text-muted">
                            <a href="{{ route('posters.index') }}" class="text-muted text-hover-primary">پوستر ها</a>
                        </li>
                        <!--end::آیتم-->
                    </ul>
                    <!--end::Breadcrumb-->
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <div class="card">
                        ...
                        <div class="card-toolbar">
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
                                    <div class="px-7 py-5">
                                        <div class="fs-5 text-dark fw-bold">فیلتر پوستر ها</div>
                                    </div>
                                ...
                                <button onclick="window.location.href='{{ route('posters.create') }}'" type="button"
                                        class="btn btn-primary" data-bs-toggle="modal"
                                        data-bs-target="#kt_modal_add_user">
                                    <i class="ki-duotone ki-plus fs-2"></i>افزودن پوستر
                                </button>
                                <!--end::Add user-->
                            </div>
                            <!--end::Toolbar-->
                    ...
                    <div class="card-body py-4">
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_items">
                            ...
                            @foreach ($objects as $item)
                                <tr>
                                    ...
                                    <td>{{ $item->link ? \Illuminate\Support\Str::limit($item->link, 150) : '---'  }}</td>

                                    <td>
                                        <div
                                            class="badge badge-light-{{ $item->get_location_class() }} active_modal_buttons">{{ $item->get_location() }}</div>
                                    </td>
                                    ...
                                    <td class="">
                                        ...
                                        <div
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="{{ route('posters.edit', $item->id) }}" class="menu-link px-3"
                                                   data-kt-posters-table-filter="delete_row">ویرایش</a>
                                            </div>
                                            <div class="menu-item px-3">

                                                <form action="{{ route('posters.destroy' , $item->id) }}"
                                                    ...
                                                    <a onclick="return Delete('{{ $loop->index }}')"
                                                       ...
                                                       data-kt-posters-table-filter="delete_row">حذف</a>
                        ...
                        <div class="row">
                            @include('dashboard.section.components.bulk_actions.bulk_actions', ['actions' => [['delete', 'حذف کردن'], ['top', 'بالا شدن'], ['center', 'وسط شدن'], ['bottom', 'پایین شدن']], 'items' => $objects])
...
@section('Scripts')
    ...
    <script>
        app.controller('myCtrl', function ($scope, $http) {
            @include('dashboard.section.components.bulk_actions.bulk_actions_js', ['items' => $objects, 'model' => \Modules\Poster\Entities\Poster::class])
        });
    </script>
@endsection
