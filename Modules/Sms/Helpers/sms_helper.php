...
class sms_helper
{
    public static $SMS_PATTERNS = [
        ...
        'user_ticket_answer_submit' => "کاربر گرامی تیکت شما با عنوان % شماره %s توسط مدیریت پاسخ داده شد.",
        'admin_ticket_answer_submit' => "مدیریت گرامی برای تیکت % با شماره %s پیام جدید ثبت شد.",
    ];
}
