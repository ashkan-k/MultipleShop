...
">
    ...
    ">
                                        ...
                                        <div class="_item__comment"
                                            ...
                                            @include('blog::livewire.pages.front.components.response_button', ['comment' => $comment ])
                                        </div>

                                    </div>

                                    @include('blog::livewire.pages.front.components.response_form', ['comment' => $comment ])
                                            ...
                                            <li class="comment byuser comment-author-h-davarian bypostauthor even depth-2 single-comment _item _person"
                                                ...
                                                <div id="comment-264585" class="comment-body">
                                                    ...
                                                    <div class="_item__comment" style="clear: both; padding: 14px;">
                                                        <p>{{ $child_1->body ?: '---' }}</p>
                                                        @include('blog::livewire.pages.front.components.response_button', ['comment' => $child_1 ])
                                                    </div>

                                                </div>

                                                @include('blog::livewire.pages.front.components.response_form', ['comment' => $child_1 ])
