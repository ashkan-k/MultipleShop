            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <div class="card">
                        ...
                        <div class="card-toolbar">
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
                                    <div class="px-7 py-5">
                                        <div class="fs-5 text-dark fw-bold">فیلتر کاربران</div>
                                    </div>
                                ...
                                <button onclick="window.location.href='{{ route('users.create') }}'" type="button"
                    ...
                    <div class="card-body py-4">
                        ...
                        <div class="row">
                            @include('dashboard.section.components.bulk_actions.bulk_actions', ['actions' => [['delete', 'حذف کردن'], ['active', 'فعال کردن'], ['deactive', 'غیر فعال کردن'], ['admin', 'مدیر کردن'], ['staff', 'کارمند کردن'], ['user', 'کاربر عادی کردن']], 'items' => $objects])
